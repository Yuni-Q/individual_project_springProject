        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="">
                        <a class="page-scroll" href="logout.do">로그아웃</a>
                    </li>
                    <li class="">
                        <a class="page-scroll" href="board.do">게시판</a>
                    </li>
                    <li class="">
                        <a class="page-scroll" href="bookList.do">글쓰기</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">BookList</h2>
                    <h3 class="section-subheading text-muted">당신이 읽은 책의 리스트 입니다.</h3>
                </div>
            </div>
            <div class="row">
